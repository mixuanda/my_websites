...
export function Mdx({ code, components }: MdxProps) {
  ...
  return (
    <div className="mdx prose max-w-none overflow-x-hidden prose-headings:text-foreground prose-p:text-foreground/95 prose-strong:text-foreground prose-li:text-foreground/95 prose-code:text-foreground prose-pre:border prose-pre:border-border/60 prose-blockquote:border-primary prose-a:text-primary">
