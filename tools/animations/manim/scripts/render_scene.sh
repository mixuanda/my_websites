...
scene_file() {
  case "$1" in
    ...
    OrthogonalSetsOrthonormalBasesStory|OrthogonalSetsOrthonormalBasesStoryEn|OrthogonalSetsOrthonormalBasesStoryZhHk|OrthogonalSetsOrthonormalBasesStoryZhCn)
      ...
      ;;
    CauchySchwarzTriangleInequalitiesStory|CauchySchwarzTriangleInequalitiesStoryEn|CauchySchwarzTriangleInequalitiesStoryZhHk|CauchySchwarzTriangleInequalitiesStoryZhCn)
...
scene_locale() {
  case "$1" in
    ...
    SpecialMatricesFamilyRecognitionStoryZhCn)
      printf '%s\n' "zh-cn"
      ;;
    BlockMatrixPartitionProductStory|BlockMatrixPartitionProductStoryEn)
      printf '%s\n' "en"
      ;;
    BlockMatrixPartitionProductStoryZhHk)
      printf '%s\n' "zh-hk"
    ...
    OrthogonalSetsOrthonormalBasesStoryZhCn)
      printf '%s\n' "zh-cn"
      ;;
    CauchySchwarzTriangleInequalitiesStory|CauchySchwarzTriangleInequalitiesStoryEn)
      printf '%s\n' "en"
      ;;
    CauchySchwarzTriangleInequalitiesStoryZhHk)
      printf '%s\n' "zh-hk"
    ...
    CauchySchwarzTriangleInequalitiesStoryZhCn)
      printf '%s\n' "zh-cn"
      ;;
    SolutionSetTypesTrichotomyStory|SolutionSetTypesTrichotomyStoryEn)
      printf '%s\n' "en"
      ;;
    SolutionSetTypesTrichotomyStoryZhHk)
      printf '%s\n' "zh-hk"
...
video_basename() {
  case "$1" in
    ...
    OrthogonalSetsOrthonormalBasesStory|OrthogonalSetsOrthonormalBasesStoryEn|OrthogonalSetsOrthonormalBasesStoryZhHk|OrthogonalSetsOrthonormalBasesStoryZhCn)
      ...
      ;;
    CauchySchwarzTriangleInequalitiesStory|CauchySchwarzTriangleInequalitiesStoryEn|CauchySchwarzTriangleInequalitiesStoryZhHk|CauchySchwarzTriangleInequalitiesStoryZhCn)
      printf '%s\n' "cauchy-schwarz-triangle-inequalities-story"
      ;;
    SolutionSetTypesTrichotomyStory|SolutionSetTypesTrichotomyStoryEn|SolutionSetTypesTrichotomyStoryZhHk|SolutionSetTypesTrichotomyStoryZhCn)
