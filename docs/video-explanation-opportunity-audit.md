...
| 7 | Math1030 | `vector-spaces/basis-and-dimension` | Build a basis from independent spanning vectors and label dimension as number of basis vectors. | The section links span, independence, and coordinates. |
