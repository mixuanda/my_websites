...
- completed an eleventh MATH1030 Manim pilot for `6.7 Matrix subspaces, basis,
  and dimension` with trilingual
  `math1030-matrix-subspace-basis-dimension-story` videos, localized posters,
  a new trilingual storyboard, article embeds after the `Sym_2(R)` worked
  example, no new widget because the source-backed free-parameter split is
...
- completed a thirteenth MATH1030 Manim pilot for `7.1 Determinants and
  cofactor expansion` with trilingual
  `math1030-determinants-cofactor-expansion-story` videos, localized posters,
  a new trilingual storyboard, article embeds after the recursive determinant
  definition, no new widget because the source-backed learning move is a
  curated cofactor-expansion and zero-pruning computation strategy, and static
  export fallback; focused QA is recorded in
  `docs/manim-determinants-cofactor-expansion-video-qa-2026-06-21.md`.
- completed a fourteenth MATH1030 Manim pilot for `7.2 Row operations,
  products, and invertibility` with trilingual
  `math1030-determinants-row-operation-effects-story` videos, localized
  posters, a new trilingual storyboard, article embeds after the determinant
  row-operation theorem, no new widget because the source-backed learning move
  is operation-effect bookkeeping rather than open-ended computation, and
  static export fallback; focused QA is recorded in
  `docs/manim-determinants-row-operation-effects-video-qa-2026-06-21.md`.
- completed a fifteenth MATH1030 Manim pilot for `7.3 Transpose, column
  operations, and Cramer's rule` with trilingual
  `math1030-determinants-column-replacement-cramers-rule-story` videos,
  localized posters, a new trilingual storyboard, article embeds after the
  opening motivation, no new widget because the source-backed learning move is
...
- completed a seventeenth MATH1030 Manim pilot for `8.2 Diagonalization and
  similarity` with trilingual
  `math1030-diagonalization-similarity-eigenbasis-story` videos, localized
  posters, a new trilingual storyboard, article embeds after the `AS=SD`
  column-package explanation, no new widget because the source-backed learning
...
- completed a nineteenth MATH1030 Manim pilot for `9.1 Inner products, norms,
  and angles` with trilingual `math1030-inner-product-norm-angle-story`
  videos, localized posters, a new trilingual storyboard, article embeds after
  the angle / orthogonality bridge, no new widget because the source-backed
  learning move is fixed algebra-to-geometry interpretation, and static export
  fallback; focused QA is recorded in
  `docs/manim-inner-products-norms-angles-video-qa-2026-06-29.md`.
- completed a twentieth MATH1030 Manim pilot for `9.2 Orthogonal sets and
  orthonormal bases` with trilingual
  `math1030-orthogonal-sets-orthonormal-bases-story` videos, localized
  posters, a new trilingual storyboard, article embeds after the coefficient
  formula and before the coordinate-reading worked example, no new widget
  because the source-backed learning move is fixed coefficient isolation by
  inner products, and static export fallback; focused QA is recorded in
  `docs/manim-orthogonal-sets-orthonormal-bases-video-qa-2026-06-30.md`.
...
- completed the fourth Math1025 Manim pass for `8.1 Polynomial arithmetic and
  division` with trilingual
  `math1025-polynomial-division-remainder-story` videos, localized posters, a
  new trilingual storyboard, article embeds after the division-algorithm
  uniqueness proof, the existing `math1025-polynomial-division-stepper`
...
- completed the twenty-third Math1030 Manim pass for `2.5 Existence of
  row-echelon forms` with trilingual
  `math1030-existence-of-row-echelon-forms-story` videos, localized posters, a
  new trilingual storyboard, article embeds after the pivot-column
  preservation theorem, added source-backed worked examples, no new widget, and
  TXT/PDF static fallback; focused QA is recorded in
  `docs/manim-existence-row-echelon-forms-video-qa-2026-06-30.md`.
- completed the twenty-sixth Math1030 Manim pass for `3.1 Matrix multiplication
  and identity matrices` with trilingual
  `math1030-matrix-multiplication-identity-story` videos, localized posters, a
  new trilingual storyboard, article embeds after the identity matrix
  paragraph, the existing `matrix-multiplication-visualizer` preserved as the
  reader-controlled follow-up, and TXT/PDF static fallback; focused QA is
  recorded in
  `docs/manim-matrix-multiplication-identity-video-qa-2026-07-01.md`.
- completed the twenty-seventh Math1030 Manim pass as a shared `3.2/3.3`
  transpose / symmetry asset with trilingual
  `math1030-transpose-symmetry-story` videos, localized posters, a new
  trilingual storyboard, article embeds in both `transpose-and-special-matrices`
  and `transposes-and-symmetric-matrices`, the existing
...
- completed the twenty-ninth Math1030 Manim pass for `3.5 Block matrices` with
  trilingual `math1030-block-matrix-partition-product-story` videos, localized
  posters, a new trilingual storyboard, article embeds after the partition
  motivation section, no new widget, and TXT/PDF static fallback; focused QA
  is recorded in `docs/manim-block-matrices-video-qa-2026-07-01.md`.
...
- continue with the next roadmap slice: Math1030 `4.1 Homogeneous systems and
  null space`, unless the roadmap priority changes.
